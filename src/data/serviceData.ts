...
const servicesData: servicesDT[] = [
    ...
    //Home two services data end
    {
        ...
        categories: ["Positionering", "Merkstrategie", "Visual identity", "Content", "Campagnes"],
        link: "/service-details-2-light",
    },
    {
        id: 10,
        title: "Webdesign & development",
        categories: ["UX design", "Next.js", "WordPress", "Performance", "SEO"],
        link: "/service-details-2-light",
    },
    {
        id: 11,
        title: "Headless commerce",
        categories: ["Shopify", "Storefront API", "Conversie", "Automatisering", "Support"],
        link: "/service-details-2-light",
    },
