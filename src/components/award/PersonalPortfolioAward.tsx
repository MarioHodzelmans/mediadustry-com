...
const AwardHeader = () => (
    <div className="tp-award-item pp-award-header p-relative mb-5 tp_fade_anim">
        <div className="row align-items-center">
            <div className="col-lg-8 col-md-6"><div className="tp-award-box-left z-index-3"><span className="tp-award-year tp-award-text-2">year</span><span className="tp-award-text tp-award-text-2">Recognition</span><span className="tp-award-text-2">platform</span></div></div>
            <div className="col-lg-4 col-md-6"><div className="tp-award-box-right z-index-3 d-flex justify-content-between align-items-center"><span className="tp-award-text-2">Project</span><span className="tp-award-icon tp-award-text-2">Link</span></div></div>
        </div>
    </div>
);
