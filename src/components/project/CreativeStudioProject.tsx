                    ...
                    <div className="row align-items-end">
                        <div className="col-lg-3">
                            <div className="creative-project-title-box">
                                <span className="tp-section-subtitle mb-20 fs-17 pre-circle tp_fade_anim" data-delay=".3">Ons werk</span>
                            </div>
                        </div>
                        <div className="col-lg-5">
                            <div className="creative-project-title-box">
                                <h4 className="tp-section-title fs-64 tp_fade_anim" data-delay=".5">Ontdek onze <br /> digitale slagkracht</h4>
                            </div>
                        </div>
